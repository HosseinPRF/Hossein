...
class Predictor:
    ...
    # تابع جدید برای پیش‌بینی و نوشتن در فایل
    def predict_and_write_to_file(self, data_dict, filename='prediction_result.txt'):
        pred_class, pred_proba = self.predict(data_dict)
...
class CombinedGUI:
    ...
    def run_prediction(self):
        ...
        try:
            ...
            # علاوه بر نمایش، در فایل هم ذخیره شود
            self.predictor.predict_and_write_to_file(input_data)
